...
L["info_popup_" .. CLAIRVOYANT.name] = [[Du bist DER Hellseher!
...
L["body_found_" .. CLAIRVOYANT.abbr] = "Er war ein Hellseher..."
L["search_role_" .. CLAIRVOYANT.abbr] = "Diese Person war ein Hellseher!"
L["target_" .. CLAIRVOYANT.name] = "Hellseher"
